...
{
    /// <summary>
    /// Creates a mock server builder from an OpenAPI specification file.
    ...
    /// <example>
    /// <code>
    /// var mock = await MockServer.FromOpenApi("api-spec.yaml")
    ...
    /// <summary>
    /// Creates a mock server builder from an OpenAPI specification stream.
    /// </summary>
    ...
    /// <summary>
    /// Creates a mock server builder from a Treaty contract.
